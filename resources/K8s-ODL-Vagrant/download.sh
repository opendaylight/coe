...
curl -o karaf-0.9.0-SNAPSHOT.tar.gz -J -L  "https://nexus.opendaylight.org/content/repositories/opendaylight.release/org/opendaylight/integration/karaf/0.9.0/karaf-0.9.0.tar.gz"
